...
def welcome():
    banner_file = open(r"{}\cli_banner.txt".format(get_script_path()))
...
def set_default_args():
    ...
    if args.output_file is None:
        output_file = "{}\{}_hashList.txt".format(get_script_path(), malware_name)
    else:
...
def find_malware_occurrences(malware_name, data, output_file):
    ...
    counter_false = 0
    false_list = []
    false_file = r"{}\false_positives.txt".format(get_script_path())
