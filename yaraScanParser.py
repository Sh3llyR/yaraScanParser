...
def parse_args():
    ...
    hash2 = "<sha256>"
    etc.
    If not provided, the output is saved as "<malware_name>_hashList.txt" in the script's directory''', default=malware_name)
    parser.add_argument('-m', dest='malware_name', help='Malware name as appears in the JSON file. If not provided, the value of the first \'malware\' key in the the JSON file is used', default=malware_name)
